...
private:
  ...
  void deleteNodes(Node*); // helper function to delete the nodes
  Node* merge(Node*, Node*); // helper function to merge heaps
  void swap(Node*&, Node*&); // helper function to swap the nodes
  void printRecords(Node*) const; // helper function to print students record in order
  Node* removeNode(Node*, Student&); // helper function to remove the node from the heap
  void reconstruct(RQueue&); // helper function to reconstruct the heap
  void copyNodes(Node*&, const Node*);
};
#endif
